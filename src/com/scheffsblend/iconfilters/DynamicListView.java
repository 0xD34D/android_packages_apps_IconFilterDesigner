...
public class DynamicListView extends ListView {
    ...
    public ArrayList<FilterListAdapter.FilterItem> mFilterList;
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        FilterListAdapter adapter = ((FilterListAdapter)getAdapter());
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mFilterList, originalItem, getPositionForView(switchView));
    ...
    public void setFilterList(ArrayList<FilterListAdapter.FilterItem> filterList) {
